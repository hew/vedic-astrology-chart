  ...
  return (
    <svg width={width} height={height} viewBox={`0 0 ${width} ${height}`}>
      ...
      <g stroke="#666" strokeWidth="1" fill="none">
        ...
        <line x1={3 * cellWidth} y1={0} x2={4 * cellWidth} y2={cellHeight} /> {/* House 10 */}
        <line x1={3 * cellWidth} y1={3 * cellHeight} x2={4 * cellWidth} y2={4 * cellHeight} /> {/* House 1 */}
        <line x1={0} y1={3 * cellHeight} x2={cellWidth} y2={4 * cellHeight} /> {/* House 4 */}
      </g>
      ...
      <g>
        {(() => {
          ...
          const firstHouseCenter = getCellCenter(firstHousePos.row, firstHousePos.col);
